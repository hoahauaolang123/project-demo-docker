...
-- Script date 7/4/2022 9:07:41 PM
...
--
CREATE PROCEDURE Proc_UpdateAccount(IN v_accountid CHAR(36), IN v_email VARCHAR(100), IN v_fullname VARCHAR(255), IN v_username VARCHAR(255), IN v_phonenumber VARCHAR(100), IN v_password VARCHAR(255), IN v_avatar TEXT, IN v_modifieddate TIMESTAMP, IN v_modifiedby VARCHAR(255), IN v_status BIT, IN v_isdeleted BIT)
  SQL SECURITY INVOKER
BEGIN
UPDATE account
SET Email = v_email,
