...
-- Script date 5/4/2022 9:42:18 PM
...
--
-- Drop procedure `Proc_GetMenus`
--
DROP PROCEDURE IF EXISTS Proc_GetMenus;

--
-- Drop procedure `Proc_GetMenusFilterPaging`
--
DROP PROCEDURE IF EXISTS Proc_GetMenusFilterPaging;
...
--
-- Drop procedure `Proc_GetPosts`
--
DROP PROCEDURE IF EXISTS Proc_GetPosts;

--
-- Drop procedure `Proc_GetPostsFilterPaging`
--
DROP PROCEDURE IF EXISTS Proc_GetPostsFilterPaging;
